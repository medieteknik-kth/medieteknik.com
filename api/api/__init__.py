...
if app.debug:
    ...
    def route_create_all():
        ...
        create_page("Studenträtt", "studentratt", "{\"ops\":[{\"insert\":\"Studenträtt\"},{\"attributes\":{\"header\":1},\"insert\":\"\\n\"},{\"insert\":\"Om du under din tid på KTH blir utsatt för någon form av diskriminering, trakasserier eller kränkande särbehandling finns sektionen och kåren här för att hjälpa till. Se Medias Uppförandepolicy under dokument.\\nOm du har frågor om din studenträtt, söker stöd eller vill anmäla en händelse kan du vända dig till sektionens Studerandeskyddsombud, \"},{\"attributes\":{\"color\":\"#c4a616\",\"link\":\"mailto:skyddsombud@medieteknik.com\"},\"insert\":\"skyddsombud@medieteknik.com\"},{\"insert\":\"eller Jämställdhets- och mångfaldsombud, \"},{\"attributes\":{\"color\":\"#c4a616\",\"link\":\"mailto:jamo@medieteknik.com\"},\"insert\":\"jamo@medieteknik.com\"},{\"insert\":\"\\nDu kan också vända dig direkt till KTH, mer information \"},{\"attributes\":{\"color\":\"#c4a616\",\"link\":\"https://www.kth.se/student/stod/halsa/diskriminering/diskriminering-1.514516\"},\"insert\":\"här\"},{\"insert\":\".\\n\"}]}")
