    ...
    <section className='h-fit'>
      <div className='pt-12 mb-10 grid place-items-center'>
        ...
        <div className='flex flex-wrap gap-12 justify-center my-8'>
          <Card
            className='bg-yellow-100 hover:scale-110 transition-transform cursor-pointer'
            onClick={() => {
              location.href = '/recruitment?committee=' + committee
            }}
          >
            <CardHeader>
              <div className='w-16 h-16 grid place-items-center border rounded-full bg-yellow-400'>
          ...
          <Card
            className='bg-red-100 hover:scale-110 transition-transform cursor-pointer'
            onClick={() => {
              location.href = '/bulletin?committee=' + committee
            }}
          >
            <CardHeader>
              <div className='w-16 h-16 grid place-items-center border rounded-full bg-red-400'>
          ...
          <Card
            className='bg-sky-100 hover:scale-110 transition-transform cursor-pointer'
            onClick={() => {
              location.href = '/bulletin?committee=' + committee
            }}
          >
            <CardHeader>
              <div className='w-16 h-16 grid place-items-center border rounded-full bg-sky-400'>
