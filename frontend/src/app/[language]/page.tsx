...
export default async function Home({ params: { language } }: { params: { language: string } }) {
  ...
  return (
    <main>
      ...
      <div className='w-screen h-screen min-h-[1080px]'>
        ...
        <div className='w-screen h-full min-h-[1080px] z-10 flex flex-col items-center justify-center'>
          <div className='w-9/12 h-full flex flex-col items-center justify-center text-center'>
            <h1 className='text-xl xs:text-4xl sm:text-7xl text-yellow-400 font-semibold tracking-wide py-8 uppercase'>{common('title')}</h1>
      ...
      <section id='international' className='w-screen h-[1080px] bg-white flex flex-row'>
