  ...
  return (
    <main>
      ...
      <div className='w-screen h-screen'>
        <div className='w-screen h-screen absolute flex justify-center items-center -z-10 top-0 overflow-x-hidden'>
          <Image 
          src={Background} 
          alt='bg' 
      ...
      <div id='international' className='w-screen h-screen bg-black'>
