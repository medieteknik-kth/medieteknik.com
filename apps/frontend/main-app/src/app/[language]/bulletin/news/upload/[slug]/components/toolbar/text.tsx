...
import { type ElementType, textTypes } from '../../util/Text'
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              aria-expanded={open}
              className={`${textTypes.find((type) => type.value === currentType)?.style} w-72 flex justify-between m-0`}
            >
                ...
                <CommandGroup heading={t('textType')}>
                  {textTypes.map((type) => (
                    <CommandItem
                      ...
                      className={`${type.style} flex items-center cursor-pointer`}
                    >
